...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@gitlab.pengpeng.la:ioscore/pputility.git", :tag => "0.0.7"}
...
#   helperSub.ios.dependency 'MJRefresh'
...
#       externCategorySub.ios.dependency 'JGProgressHUD'
#       externCategorySub.ios.dependency 'MDHTMLLabel'
#       externCategorySub.ios.dependency 'MLLabel'
...
#        othersCategorySub.ios.dependency 'SDVersion'
...
#    spec.ios.dependency 'PPUtilities/Helper'
#    spec.ios.dependency 'PPUtilities/Macro'
#    spec.ios.dependency 'PPUtilities/Category'   
#    spec.ios.dependency 'PPUtilities/ExternCategory'
#    spec.ios.dependency 'PPUtilities/IMCategory'
#    spec.ios.dependency 'PPUtilities/JSON'
#    spec.ios.dependency 'PPUtilities/NSStringCategory'
#    spec.ios.dependency 'PPUtilities/OthersCategory'
#    spec.ios.dependency 'PPUtilities/StoryboardHelper'
#    spec.ios.dependency 'PPUtilities/UIButtonCategory'
#    spec.ios.dependency 'PPUtilities/UIImageCategory'
#    spec.ios.dependency 'PPUtilities/UINavigationBarCategory'
#    spec.ios.dependency 'PPUtilities/UIViewCategory'
#  end 


#    s.source_files  = "PPUtilities/Macro/*.{h,m}","PPUtilities/Categorys/*.{h,m}","PPUtilities/Helper/**/*.{h,m}"
#    s.source_files  =  "PPUtilities/**/*.{h,m}"

#   s.subspec 'MRC' do |spec|
#   spec.requires_arc            = false
#   spec.compiler_flags          = '-ObjC'
#   spec.source_files  = "MRC/**/*.{h,m}"#   
#   end 

#  s.subspec 'ARC' do |spec|
#    spec.requires_arc            = true
#    spec.source_files  = "Categorys/**/*.{h,m}","Common/**/*.{h,m}","Helper/**/*.{h,m}"
#  end 
