...
Pod::Spec.new do |s|
  ...
  s.name         = "PPShareSDK"
  s.version      = "0.3.0"
  s.summary      = "PPShareSDK support share(contains:SinaWeibo Wechat RenRen Tencent FaceBook Twitter WhatsApp Line)"
  s.homepage     = "https://github.com/upworldcjw"
  s.license      = "MIT"
  s.author             = { "jianwei.chen" => "1042294579@qq.com" }
  s.platform     = :ios, "7.0"
 
  s.source       = { :git => "git@gitlab.pengpeng.la:ioscore/ppthirdsdk.git", :tag => "0.3.0" }
