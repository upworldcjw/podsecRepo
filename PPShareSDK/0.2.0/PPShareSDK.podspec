...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@gitlab.pengpeng.la:ioscore/ppthirdsdk.git", :tag => "0.2.0" }
...
#   spec.ios.dependency  'PPUtilities' 
  ...
  s.subspec 'WhatsApp' do |ss|
      ss.source_files  = 'PPShareSDK/WhatsApp/*.{h,m}','PPShareSDK/NBShareServiceHeader.h'
  end

  s.subspec 'Twitter' do |ss|
      ss.source_files  = 'PPShareSDK/Twitter/*.{h,m}','PPShareSDK/NBShareServiceHeader.h'
      s.frameworks = "Social"
  end
