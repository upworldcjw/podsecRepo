...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "git@gitlab.pengpeng.la:ioscore/ppthirdsdk.git", :tag => "0.0.2" }
...
#    end
  ...
  s.subspec 'Wechat' do |ss|
      ss.source_files  = 'PPShareSDK/Wechat/*.{h,m}','PPShareSDK/NBShareServiceHeader.h','PPShareSDK/UIView+tmpImage.h'
  ...
  s.subspec 'Tencent' do |ss|
      ss.source_files  = 'PPShareSDK/Tencent/*.{h,m}','PPShareSDK/NBShareServiceHeader.h','PPShareSDK/UIView+tmpImage.h'
